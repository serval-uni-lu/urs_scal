...
z3 = pd.read_csv("data/z3.nind.csv", skipinitialspace = True, index_col = 'file')
ms = pd.read_csv("data/minisat.nind.csv", skipinitialspace = True, index_col = 'file')
...
mis = pd.read_csv("data/mis.arjun.nind.csv", skipinitialspace = True, index_col = 'file')
...
unigen3 = pd.read_csv("data/unigen3.nind.csv", skipinitialspace = True, index_col = 'file')
spur = pd.read_csv("data/spur.nind.csv", skipinitialspace = True, index_col = 'file')
quicksampler = pd.read_csv("data/quicksampler.nind.csv", skipinitialspace = True, index_col = 'file')
...
cms = pd.read_csv("data/cmsgen.nind.csv", skipinitialspace = True, index_col = 'file')
...
def gen_tables(data, title):
    ...
    d_list = [data['#var'], data['#clause'], data['#literal'], data.tw, data['lp'], data['#mis'], data['time_z3'], data['mem_z3'], data['time'], data['mem']]
    n_list = ['#v', '#c', '#l', 'tw', 'deff', '#mis', 'time_z3', 'mem_z3', 'time', 'mem']
