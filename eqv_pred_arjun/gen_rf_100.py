...
# data = data.join(patoh, rsuffix = '_patoh', on = 'filnb_cls
...
def run_poly(data, title, key):
    ...
    X = data[['#var', '#clause', 'tw', '#mis']].to_numpy()
...
ipk4 = ['#var']
ipk5 = ['#clause']
ipk6 = ['#var', '#clause', '#literal', 'tw', 'lp', '#mis', 'time_z3', 'mem_z3']
ipk7 = ['#var', '#clause', '#literal', 'tw', 'lp', '#mis']
ipk8 = ['#var', '#clause', 'tw', 'lp', '#mis']
ipk9 = ['#var', 'tw', 'lp', '#mis']
ipk10 = ['#var', 'tw', 'deff', '#mis']
ipk11 = ['#var', 'deff', '#mis']
ipk12 = ['#var', 'deff', '#mis']
# ipk13 = ['#var', 'deff', '#eqv']
ipk14 = ['#var', 'deff']
